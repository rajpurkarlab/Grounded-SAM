...
def load_data(batch_size=16, h5_file='/n/data1/hms/dbmi/rajpurkar/lab/Grounded-SAM/initial_experiments/data/mimic_small.h5', num_workers=0):
    """Get dataloader for training.
    """
    dataset = MIMICCXRDataset(h5_file=h5_file)
...
class UnitTest:
    ...
    def load_data_test(self):
        dataloader = load_data(num_workers=4)
