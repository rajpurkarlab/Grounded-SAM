            ...
            if annots['counts'] != 'ifdl3': # ifdl3 denotes an empty ground-truth mask; skip over these test samples
                ...
                if model == "grounded-sam":
                    if use_sam:
                        ...
                        bbox, logits, phrases = groundingdino.predict([filename], [text_prompt], box_threshold=0.0)
                        print(phrases.shape, phrases[0])
...
class UnitTest:
    ...
    def run_eval_scripts(self):
        ...
        # print("Grounded-SAM, CheXlocalize: ", eval_results(
        #     "chexlocalize", "grounded-sam", use_sam=False,
        #     ckpt_file="./initial_experiments/ckpts_2/initial_experiments_groundingdino_backbone_101.pth",
        # ))
        
        # print("Starting Grounded-SAM, PASCAL...")
        # print("Grounded-SAM, PASCAL: ", eval_results(
        #     "pascal", "grounded-sam", use_sam=False,
        #     ckpt_file="./initial_experiments/ckpts_2/initial_experiments_groundingdino_backbone_101.pth",
        # ))
